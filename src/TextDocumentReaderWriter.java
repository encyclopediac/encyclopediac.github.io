    ...
    private static void produceTableOfContents() throws Exception{
        ...
        for (String headers : listOfHeaderLinks) {
            ...
            if (lastH1FoundInLoop != currentH1FoundInLoop) {
                ...
                tableOfContentsWriter.write("<ul><li><a target=\"_blank\" href=\"" + TOC_BASE_HYPERLINK + headers.split("href=\"#")[1] + " (<a target=\"_blank\" href=\"https://encyclopediac.github.io/subtopics/" + headers.split("\">")[1].split("</a>")[0] + ".html\" style=\"color:blue;text-decoration:underline\">dedicated page here</a>)</li></ul>");
